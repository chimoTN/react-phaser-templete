...
export class Niveau1 extends Scene{
    ...
    preload ()
    {
        this.load.tilemapTiledJSON('map', 'public/assets/Niveau1.json');
        this.load.image('Pixi2', 'public/assets/Pixi2.png');
        ...
        this.load.spritesheet('player', 'public/assets/dude-cropped.png', { frameWidth: 12, frameHeight: 16 });
    ...
    create () {
        ...
        */
        ...
        this.playerController.dashSpeed = 15; // Vitesse de dash
        ...
        this.playerController.dashTime = 0; // Contrôle du timing du dash
           ...
           const zoomFactor = 5; // Définir le facteur de zoom pour agrandir les tuiles
    ...
    mapManager(){
        ...
        const tileset = this.map.addTilesetImage('Pixi2');
        ...
        objectLayer.forEach(obj => {
            ...
            objectBody.uniqueID = properties.find(p => p.name === "ExitMap");  // Supposons que chaque objet a une propriété 'uniqueID'
        });
